...
import Volumetricsettings from './Volumetricsettings';
        ...
        <div className={includetypes.includes(props.config.condition) ? style.singleCondition + ' ' + style.multiSelect : style.singleCondition}>
            <SelectInput type="select" value={props.config.condition} options={conditionallowdfor} onChange={props.handleUpdate} name="condition" index={props.index}  cmnt="method" /> 
            {
                ...
                <>
                    ...
                    <TextInput value={props.config.cvalue} type="number" max="999999999999" min="0" onChange={props.handleUpdate} index={props.index} name="cvalue" cmnt="method" />
                </>
            }
...
const Methodconditions = (props) => {
    const [conditionAllowdFor, setConditionAllowdFor] = useState({
        subtotal: 'Subtotal', 
        quantity: 'Quantity',
        weight: 'Weight', 
        height: 'Height', 
    ...
    const singleConditionSelector = (event) => {
    ...
    return (
        ...
        <Tabs instance_id={props.instance_id} />
            <div className={style.wrap}>
                <Volumetricsettings config={props.config.method} handleUpdate={props.handleUpdate} />
                <div className={style.headerAdditional}>
                    ...
                    {
                        props.config.method.method_condtion.map((v, index) => {
                                return(
                                        <Singlecondition 
                                        index={index}
                                        key={index} 
                                        conditionallowdfor={conditionAllowdFor} 
                                        singleconditionselector={singleConditionSelector} 
                                        options={options} 
                                        ...
                                        resetDatePicker={props.resetDatePicker}
                                    />
                                );
                        })
                    }
                ...
                <div className={style.text_center}>
                    <button className={style.addNewCondition} onClick={props.addnew} type="button">
...

                    {
                        (()=>{
                            if(props.config.general.title != ''){
                                return(
                                    <>
                                        <NavLink className={style.navlink} onClick={(e) => {props.saveHandler(e)}} to={`/${params.instance_id}/additional_options`} > 
