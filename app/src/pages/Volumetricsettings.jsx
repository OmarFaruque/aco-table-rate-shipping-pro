...
class Volumetricsettings extends React.Component {
    ...
    render() {
        ...
        <div className={style.wrap}>
            ...
            {/* Volume Number */}
            <label>{__('Volume Number','advanced-table-rate-shipping-for-woocommerce')} <span data-tip data-for="volumeNumber" className={style.tooltip + ' dashicons dashicons-editor-help'}>
                <ReactTooltip id="volumeNumber" place="top" effect="solid">
                    {__('Volume number calculation method', 'advanced-table-rate-shipping-for-woocommerce')}
                </ReactTooltip>
                </span></label>
            ...
            {/* Operand */}
            <label>{__('Operand','advanced-table-rate-shipping-for-woocommerce')} <span data-tip data-for="operand" className={style.tooltip + ' dashicons dashicons-editor-help'}>
                <ReactTooltip id="operand" place="top" effect="solid">
                    {__('Operand for calculate volume.', 'advanced-table-rate-shipping-for-woocommerce')}
                </ReactTooltip>
                </span>
            </label>
            <SelectInput 
